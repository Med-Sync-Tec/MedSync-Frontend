...
export const Input: React.FC<InputProps> = ({ label, id, className, error, ...props }) => {
  return (
    <div className={`space-y-1.5 ${className || ''}`}>
      ...
      <input 
        id={id}
        className={`block w-full rounded-xl border px-4 py-3.5 text-gray-900 dark:text-white placeholder-gray-400 focus:bg-white dark:focus:bg-gray-900 focus:ring-2 transition-all sm:text-sm ${
          error 
