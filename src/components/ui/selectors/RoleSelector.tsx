  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      >
        ...
        <span className={`text-xs ${role === 'doctor' ? 'text-primary font-bold' : 'text-gray-600 dark:text-gray-300 font-medium'}`}>
          Doctor
        </span>
        {role === 'doctor' && (
      ...
      >
        ...
        <span className={`text-xs ${role === 'coo' ? 'text-primary font-bold' : 'text-gray-600 dark:text-gray-300 font-medium'}`}>
          Director (COO)
        </span>
        {role === 'coo' && (
          <div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-primary"></div>
