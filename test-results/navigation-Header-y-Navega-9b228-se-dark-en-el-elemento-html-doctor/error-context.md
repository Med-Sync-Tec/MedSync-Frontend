...
- Name: navigation.spec.ts >> Header y Navegación — Doctor >> UAT-NAV-19 | el tema oscuro aplica la clase "dark" en el elemento html
- Location: e2e\navigation.spec.ts:155:3
...
Call log:
  - waiting for locator('button[aria-label*="Activar modo oscuro"]')
