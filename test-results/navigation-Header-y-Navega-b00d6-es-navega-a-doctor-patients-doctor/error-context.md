...
- Name: navigation.spec.ts >> Header y Navegación — Doctor >> UAT-NAV-05 | clic en "Pacientes" navega a /doctor/patients
- Location: e2e\navigation.spec.ts:55:3
...
Call log:
  - waiting for locator('nav a[href="/doctor/patients"]')
