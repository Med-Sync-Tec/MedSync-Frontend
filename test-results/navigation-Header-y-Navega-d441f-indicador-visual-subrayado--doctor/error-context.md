...
- Name: navigation.spec.ts >> Header y Navegación — Doctor >> UAT-NAV-07 | el link activo tiene el indicador visual (subrayado)
- Location: e2e\navigation.spec.ts:66:3
...
Locator: locator('nav a[aria-current="page"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('nav a[aria-current="page"]')
