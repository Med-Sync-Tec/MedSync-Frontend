...
- Name: coo-dashboard.spec.ts >> Dashboard del COO >> UAT-COODASH-06 | KPI "Alta evidencia" está visible en vista Explorar
- Location: e2e\coo-dashboard.spec.ts:53:3
...
Locator: locator('text=Alta evidencia').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Alta evidencia').first()
