...
- Name: coo-dashboard.spec.ts >> Dashboard del COO >> UAT-COODASH-05 | KPI "Medicamentos" muestra el total del inventario
- Location: e2e\coo-dashboard.spec.ts:49:3
...
Locator: locator('text=Medicamentos')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Medicamentos')
