...
- Name: navigation.spec.ts >> Header y Navegación — Doctor >> UAT-NAV-25 | Ctrl+K enfoca el campo de búsqueda global
- Location: e2e\navigation.spec.ts:209:3
...
Locator: locator('input[placeholder*="Buscar"], input[placeholder*="buscar"]').first()
Expected: focused
Timeout: 3000ms
Error: element(s) not found

Call log:
  - Expect "toBeFocused" with timeout 3000ms
  - waiting for locator('input[placeholder*="Buscar"], input[placeholder*="buscar"]').first()
