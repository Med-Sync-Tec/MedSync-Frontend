...
- Name: navigation.spec.ts >> Header y Navegación — Doctor >> UAT-NAV-02 | clic en el logo redirige al dashboard del doctor
- Location: e2e\navigation.spec.ts:39:3
...
Call log:
  - waiting for locator('header a[aria-label*="MedSync"]')
