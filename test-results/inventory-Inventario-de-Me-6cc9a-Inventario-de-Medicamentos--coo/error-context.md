...
- Name: inventory.spec.ts >> Inventario de Medicamentos >> UAT-INV-01 | muestra el título "Inventario de Medicamentos"
...
Locator: locator('h1').filter({ hasText: 'Inventario de Medicamentos' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1').filter({ hasText: 'Inventario de Medicamentos' })
