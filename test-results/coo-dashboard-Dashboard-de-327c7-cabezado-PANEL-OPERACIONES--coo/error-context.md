...
- Name: coo-dashboard.spec.ts >> Dashboard del COO >> UAT-COODASH-01 | muestra el encabezado "PANEL OPERACIONES"
- Location: e2e\coo-dashboard.spec.ts:28:3
...
Locator: locator('text=/PANEL OPERACIONES/i')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/PANEL OPERACIONES/i')
