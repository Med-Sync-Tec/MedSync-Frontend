...
- Name: patients-list.spec.ts >> Lista de Pacientes >> UAT-PAT-05 | muestra esqueletos de carga mientras se obtienen los pacientes
- Location: e2e\patients-list.spec.ts:50:3
...
Call log:
  ...
  - waiting for locator('text=Cargando…')
