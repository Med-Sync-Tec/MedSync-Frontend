...
- Name: navigation.spec.ts >> Header y Navegación — Doctor >> UAT-NAV-06 | clic en "Inicio" regresa al dashboard
- Location: e2e\navigation.spec.ts:60:3
...
Call log:
  - waiting for locator('nav a[href="/doctor/dashboard"]')
