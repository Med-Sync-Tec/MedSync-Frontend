...
- Name: navigation.spec.ts >> Header y Navegación — Doctor >> UAT-NAV-21 | botón hamburguesa está visible en viewport móvil
- Location: e2e\navigation.spec.ts:176:3
...
Locator: locator('button[aria-label="Abrir menú"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button[aria-label="Abrir menú"]')
