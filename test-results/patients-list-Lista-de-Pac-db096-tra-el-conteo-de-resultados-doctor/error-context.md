...
- Name: patients-list.spec.ts >> Lista de Pacientes >> UAT-PAT-03 | la barra superior muestra el conteo de resultados
- Location: e2e\patients-list.spec.ts:40:3
...
Locator: locator('text=/\\d+ resultado/')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/\\d+ resultado/')
