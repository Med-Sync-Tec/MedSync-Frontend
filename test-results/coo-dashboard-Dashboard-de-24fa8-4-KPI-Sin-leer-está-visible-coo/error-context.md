...
- Name: coo-dashboard.spec.ts >> Dashboard del COO >> UAT-COODASH-04 | KPI "Sin leer" está visible
- Location: e2e\coo-dashboard.spec.ts:45:3
...
Call log:
  ...
  - waiting for locator('text=Sin leer')
