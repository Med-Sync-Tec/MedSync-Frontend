...
- Name: patients-list.spec.ts >> Lista de Pacientes >> UAT-PAT-04 | texto de ayuda indica que se puede hacer clic para ver historial
- Location: e2e\patients-list.spec.ts:44:3
...
Locator: locator('text=Haz clic en un paciente para abrir su historial')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Haz clic en un paciente para abrir su historial')
