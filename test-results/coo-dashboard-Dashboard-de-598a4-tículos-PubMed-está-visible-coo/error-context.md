...
- Name: coo-dashboard.spec.ts >> Dashboard del COO >> UAT-COODASH-03 | KPI "Artículos PubMed" está visible
- Location: e2e\coo-dashboard.spec.ts:41:3
...
Locator: locator('text=/Artículos PubMed|Artículos/')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/Artículos PubMed|Artículos/')
