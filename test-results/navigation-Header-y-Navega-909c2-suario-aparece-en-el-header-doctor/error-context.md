...
- Name: navigation.spec.ts >> Header y Navegación — Doctor >> UAT-NAV-08 | el nombre del usuario aparece en el header
- Location: e2e\navigation.spec.ts:76:3
...
Locator: locator('button[aria-haspopup="menu"]')
Expected: visible
Timeout: 5000ms
