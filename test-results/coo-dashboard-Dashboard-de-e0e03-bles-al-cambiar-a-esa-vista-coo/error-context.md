...
- Name: coo-dashboard.spec.ts >> Dashboard del COO >> UAT-COODASH-08 | KPIs de Guardadas son visibles al cambiar a esa vista
- Location: e2e\coo-dashboard.spec.ts:64:3
...
Call log:
  - waiting for locator('text=Guardadas')
