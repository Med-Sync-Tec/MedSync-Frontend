...
- Name: patients-list.spec.ts >> Lista de Pacientes >> UAT-PAT-02 | muestra el total de pacientes en el subtítulo
- Location: e2e\patients-list.spec.ts:34:3
...
Locator: locator('text=/\\d+ pacientes? registrad/')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/\\d+ pacientes? registrad/')
