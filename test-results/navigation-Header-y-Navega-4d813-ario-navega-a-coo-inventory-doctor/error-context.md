...
- Name: navigation.spec.ts >> Header y Navegación — COO >> UAT-NAVCO-02 | clic en "Inventario" navega a /coo/inventory
- Location: e2e\navigation.spec.ts:240:3
...
Call log:
  - waiting for locator('nav a[href="/coo/inventory"]')
