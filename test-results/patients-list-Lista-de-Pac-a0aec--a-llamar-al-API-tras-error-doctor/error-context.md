...
- Name: patients-list.spec.ts >> Lista de Pacientes >> UAT-PAT-08 | botón "Reintentar" vuelve a llamar al API tras error
- Location: e2e\patients-list.spec.ts:80:3
...
Locator: locator('text=Reintentar')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('text=Reintentar')
