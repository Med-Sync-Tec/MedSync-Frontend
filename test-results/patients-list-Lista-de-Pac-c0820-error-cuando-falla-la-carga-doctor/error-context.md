...
- Name: patients-list.spec.ts >> Lista de Pacientes >> UAT-PAT-07 | muestra estado de error cuando falla la carga
- Location: e2e\patients-list.spec.ts:72:3
...
Locator: locator('text=Error al cargar pacientes')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('text=Error al cargar pacientes')
